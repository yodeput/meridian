...
import { getMyPositions, getPositionPnl, closePosition } from "./adapters/dlmm.js";
import { getWalletBalances } from "./adapters/wallet.js";
import { getTopCandidates } from "./adapters/screening.js";
...
import { registerCronRestarter } from "./agent/tools/executor.js";
import { startPolling, stopPolling, sendMessage, sendHTML, notifyOutOfRange, isEnabled as telegramEnabled } from "./adapters/telegram.js";
import { generateBriefing } from "./adapters/briefing.js";
import { getLastBriefingDate, setLastBriefingDate, getTrackedPosition, setPositionInstruction } from "./core/state.js";
import { getActiveStrategy } from "./core/strategy-library.js";
import { recordPositionSnapshot, recallForPool } from "./core/pool-memory.js";
import { checkSmartWalletsOnPool } from "./adapters/smart-wallets.js";
import { getTokenHolders, getTokenNarrative, getTokenInfo } from "./adapters/token.js";

log("startup", "DLMM LP Agent starting...");
log("startup", `Mode: ${config.runtime.dryRun ? "DRY RUN" : "LIVE"}`);
log("startup", `Model: ${config.llm.llmModel || "hermes-3-405b"}`);
...
Focus on: hold duration, entry/exit timing, what win rates look like, whether scalpers or holders dominate.`,
    ...
    if (input === "/evolve") {
      await runBusy(async () => {
        ...
        const lessonsData = readJson("lessons.json") || { performance: [] };
