...
if (process.argv.includes("--dry-run")) config.runtime.dryRun = true;
...
switch (subcommand) {
  ...
  // ── balance ──────────────────────────────────────────────────────
  case "balance": {
    const { getWalletBalances } = await import("../adapters/wallet.js");
  ...
  // ── positions ────────────────────────────────────────────────────
  case "positions": {
    const { getMyPositions } = await import("../adapters/dlmm.js");
  ...
  case "pnl": {
    ...
    const { getPositionPnl, getMyPositions } = await import("../adapters/dlmm.js");
  ...
  // ── candidates ───────────────────────────────────────────────────
  case "candidates": {
    const { getTopCandidates } = await import("../adapters/screening.js");
    const { getActiveBin } = await import("../adapters/dlmm.js");
    const { getTokenInfo, getTokenHolders, getTokenNarrative } = await import("../adapters/token.js");
    const { checkSmartWalletsOnPool } = await import("../adapters/smart-wallets.js");
  ...
  case "token-info": {
    ...
    const { getTokenInfo } = await import("../adapters/token.js");
  ...
  case "token-holders": {
    ...
    const { getTokenHolders } = await import("../adapters/token.js");
  ...
  case "token-narrative": {
    ...
    const { getTokenNarrative } = await import("../adapters/token.js");
  ...
  case "pool-detail": {
    ...
    const { getPoolDetail } = await import("../adapters/screening.js");
  ...
  case "search-pools": {
    ...
    const { searchPools } = await import("../adapters/dlmm.js");
  ...
  case "wallet-positions": {
    ...
    const { getWalletPositions } = await import("../adapters/dlmm.js");
  ...
  case "deploy": {
    ...
    const { executeTool } = await import("../agent/tools/executor.js");
  ...
  // ── screen ───────────────────────────────────────────────────────
  case "screen": {
    const { runScreeningCycle } = await import("../app.js");
  ...
  // ── manage ───────────────────────────────────────────────────────
  case "manage": {
    const { runManagementCycle } = await import("../app.js");
  ...
  case "study": {
    ...
    const { studyTopLPers } = await import("../adapters/study.js");
  ...
  // ── start ────────────────────────────────────────────────────────
  case "start": {
    const { startCronJobs } = await import("../app.js");
  ...
  case "withdraw-liquidity": {
    ...
    const { withdrawLiquidity } = await import("../adapters/dlmm.js");
  ...
  case "add-liquidity": {
    ...
    if (!flags.pool) die("--pool is required");
    const { addLiquidity } = await import("../adapters/dlmm.js");
